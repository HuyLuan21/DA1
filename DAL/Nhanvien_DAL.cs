...
namespace DAL
{
    public class Nhanvien_DAL
    {
        ...
        {
            string query = "SELECT MaNhanVien AS \"Mã nhân viên\",HoTen AS \"Họ tên\",NgaySinh AS\"Ngày sinh\",DiaChi AS\"Địa chỉ\",SoDienThoai AS\"Số điện thoại\",CMND_CCCD AS \"CCCD\" FROM NhanVien";
            return DataProvider.Instance.ExecuteQuery(query);
        }

        public int InsertStaff(Nhanvien_DTO staff)
        {
        ...
        public int UpdateStaff(Nhanvien_DTO staff)
        {
