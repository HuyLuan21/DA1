...
namespace DTO
{
    public class CaChieu_DTO
    {
        ...
        public CaChieu_DTO() { }
        public CaChieu_DTO(int MaCaChieu, int MaPhong, int MaPhim, string TenPhim, DateTime ThoiGianChieu, DateTime ThoiGianKetThuc, decimal GiaVe)
        {
